...
<div class="constitution">
    <h1 class="noUnderscore">NOT UPDATED TO LEAGUE OF OUR OWN ------- LEGENDS LEAGUE CONSTITUTION</h1>
    ...
    <p>4 Taxi Squad Spots (Player must be a rookie to be inserted to Taxi Squad. Sophomore players are allowed to stay in the Taxi Squad for an additional year if they never left the Taxi Squad.)</p>
    ...
    <div class="subBlock">
        <p>The trade deadline will be set for the end of the fantasy regular season, week 14.</p>
    </div>
    ...
    <p>FAAB Waiver wire system. Each team will begin the season with $100. $0 bids are allowed. Bids will process Thursdays 9AM EST.</p>

    <p>Regular Season FAAB budgets will reset each season in January.</p>

    <p>Off-season FAAB budgets after the NFL Draft. $0 bids are allowed. Bids will process weekly Wednesdays 12PM EST.</p>
    
    
    <h2 class="sectionHeading" bind:this={two}>Section 2 Drafting</h2>
    
    <h3 bind:this={twoOne}>2.1 Draft Order</h3>
    <p>The draft order each year will be a linear draft in reverse order of the previous year’s team rankings of max Points For.</p>

    <h3 bind:this={twoTwo}>2.2 Rookie Drafts</h3>
    <p>Rokkie drafts will consist of 4 rounds of drafting, with 24 hours alotted for each pick. </p>
    <p>Any spots not filled during the draft, can be filled immediately afterwards from the waiver wire.</p>
    
    <h2 class="sectionHeading" bind:this={three}>Section 3 Scoring System</h2>

    <h3 bind:this={threeOne}>3.1 Scoring System</h3>
    <p>The league scoring system breakdown is listed on the Sleeper fantasy app. The scoring system will never change without a majority league vote.</p>
    
    <h2 class="sectionHeading" bind:this={four}>Section 4 Postseason</h2>
    
    <h3 bind:this={fourOne}>4.1 Playoffs</h3>
    <p>At the end of the season 6 teams will make the playoffs. The first round of playoffs will commence in week 15. Each team that wins their division and the 3 wild card teams that finish with the best records, will receive a playoff berth. The 2 division winners with the best records will receive a bye week in the first round of the playoffs. The third division winner will automatically get the #3 seed. Each playoff matchup will only last one week and the winner will advance. Week 18 will not be used.</p>
    
    <h3 bind:this={fourTwo}>4.2 Seeding Tiebreakers</h3>
    <p>[TO BE FINALIZED] If two teams finish with the same record the tiebreakers will go as followed:</p>
    ...
    <p>League dues are set at ${dues}. Dues are collected through Thinh's venmo and bank account. [WAIVED FOR FIRST YEAR OF PAYOUTS] All managers must be fully paid up before the start of regular season. In the event that a manager fails to pay before the deadline, a 10% penalty will be addd to their payment and will go towards the payouts at the end of the year.</p>
